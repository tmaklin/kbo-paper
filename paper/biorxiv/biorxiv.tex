...
%%
%% This file is part of the 'biorxiv Bundle'.
%% ---------------------------------------------
%%
...
%%
%% The list of all files belonging to the 'biorxiv Bundle' is
%% given in the file `manifest.txt'.
%%
%% Template article for OXFORD UNIVERSITY PRESS's document class `biorxiv' 
%% with bibliographic references
%%

%%%CONTEMPORARY%%%
\documentclass[unnumsec,webpdf,modern,large]{biorxiv}%
%\documentclass[unnumsec,webpdf,modern,large,namedate]{biorxiv}% uncomment this line for author year citations and comment the above
%\documentclass[unnumsec,webpdf,contemporary,medium]{biorxiv}
%\documentclass[unnumsec,webpdf,contemporary,small]{biorxiv}

%%%MODERN%%%
%\documentclass[unnumsec,webpdf,modern,large]{biorxiv}
%\documentclass[unnumsec,webpdf,modern,large,namedate]{biorxiv}% uncomment this line for author year citations and comment the above
%\documentclass[unnumsec,webpdf,modern,medium]{biorxiv}
%\documentclass[unnumsec,webpdf,modern,small]{biorxiv}

%%%TRADITIONAL%%%
%\documentclass[unnumsec,webpdf,traditional,large]{biorxiv}
%\documentclass[unnumsec,webpdf,traditional,large,namedate]{biorxiv}% uncomment this line for author year citations and comment the above
%\documentclass[unnumsec,namedate,webpdf,traditional,medium]{biorxiv}
%\documentclass[namedate,webpdf,traditional,small]{biorxiv}
...
\address[1]{\orgdiv{Department of Biostatistics}, \orgname{University of Oslo}, \orgaddress{\state{Oslo}, \country{Norway}}}
\address[2]{\orgdiv{Department of Computer Science}, \orgname{University of Helsinki}, \orgaddress{\state{Helsinki}, \country{Finland}}}
